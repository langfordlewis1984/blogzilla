export default function ContactPage() {
  return (
    <div className="flex flex-col">
      <div className="flex flex-col">
        <h2 className="text-green-500 my-4 ml-10 text-3xl font-black hover:text-red-700">
          Contact Me, Mortals!
        </h2>
      ...
      <div className="flex flex-col items-end">
        <h2 className="text-green-500 mr-10 my-4 text-3xl font-black hover:text-red-700 flex items-end">
          Subject Line: Roar or Regret
        </h2>
        <p className="mr-10 text-right max-w-sm content-end">
          Choose your words wisely, for my colossal intellect demands attention.
          Whether you wish to discuss my epic battles, offer tribute in the form
          of Godzilla-sized pizzas, or just share your admiration for my scaly
          greatness, make sure your subject line is as attention-grabbing as my
          atomic breath.
        </p>
      </div>
      <div className="flex flex-col">
      ...
      <div className="flex flex-col items-end">
        <h2 className="text-green-500 mr-10 my-4 text-3xl font-black hover:text-red-700 flex items-end">
          Send the Message: Face the Consequence
        </h2>
        <p className="mr-10 text-right max-w-sm content-end">
      ...
      <button className="circuit-board border-2 border-red-700 mt-10 p-6 rounded-lg shadow-md transition-transform duration-300 transform hover:-translate-y-1 justify-center">
        Laser Guided Mail
      </button>
    </div>
  );
